...
//	}
	public Level createLevel(int random1){
		...
		door1 = new LevelDoor(0, 255, 50, 70, 1, true);
		addObject(door1);
		door2 = new LevelDoor(650, 255, 50, 70, 1, true);
		addObject(door2);
		door3 = new LevelDoor(315, 0, 70, 50, 1, true);
		addObject(door3);
		door4 = new LevelDoor(315, 525, 70, 50, 1, true);
		addObject(door4);
		addObject(l);
		return l;
	}
